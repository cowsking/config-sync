module github.com/google/kpt-config-sync/examples/post-sync
...
require (
	github.com/GoogleContainerTools/config-sync v1.21.0
...
// Pin kubernetes dependencies to v0.32.2
replace (
	github.com/GoogleContainerTools/config-sync => ../..
...
require (
	...
	sigs.k8s.io/cli-utils v0.37.3-0.20250410211241-63a8e151c476 // indirect
